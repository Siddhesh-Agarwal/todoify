          ...
          <div className="relative hidden flex-col justify-between border-r border-border p-12 lg:flex">
            <div className="space-y-6">
              ...
              <div className="auth-line max-w-sm font-mono text-xs leading-relaxed tracking-[0.03em] text-muted-foreground">
                Register a new operator profile. Credentials are encrypted and stored locally. Each operator maintains an isolated task database.
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-6 font-mono text-[10px] uppercase tracking-[0.08em] text-muted-foreground">
                <span>D1 // STANDBY</span>
                <span>FTS5 // INDEXING</span>
          ...
          <div className="flex flex-col justify-center p-8 lg:p-12">
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              <div className="auth-input space-y-2">
                ...
                <Input id="name" autoComplete="name" placeholder="operator-id" {...form.register("name")} />
              ...
              <div className="auth-input space-y-2">
                ...
                <Input id="email" autoComplete="email" placeholder="user@domain.dev" {...form.register("email")} />
              ...
              >
                {mutation.isPending ? "PROVISIONING..." : "EXECUTE REGISTRATION"}
              </Button>
